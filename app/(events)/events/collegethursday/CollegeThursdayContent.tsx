  ...
  return (
    <DownloadQueueProvider eventId={event.id}>
      <PhoneUnlockProvider websiteLabel={WEBSITE_LABEL}>
        <CollegeThursdayInner event={event} initialPhotos={initialPhotos} totalCount={totalCount} hasMore={hasMore} />
      </PhoneUnlockProvider>
    </DownloadQueueProvider>
  );
}

function CollegeThursdayInner({ event, initialPhotos, totalCount, hasMore }: CollegeThursdayContentProps) {
