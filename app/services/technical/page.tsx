          ...
          <div className="bg-gradient-to-br from-surface via-surface to-surface/80 border border-border/50 rounded-2xl p-10 md:p-12 shadow-xl shadow-black/20 backdrop-blur-sm">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors">
                ...
                <div>
                  <p className="text-white font-medium text-lg">Architecture review and planning</p>
                  <p className="text-muted text-sm mt-1">Comprehensive system design analysis</p>
                </div>
              </li>
              <li className="flex items-start gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center mt-0.5">
                ...
                <div>
                  <p className="text-white font-medium text-lg">Technology stack recommendations</p>
                  <p className="text-muted text-sm mt-1">Best-fit tools for your specific needs</p>
                </div>
              </li>
              <li className="flex items-start gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center mt-0.5">
                ...
                <div>
                  <p className="text-white font-medium text-lg">Workflow optimization</p>
                  <p className="text-muted text-sm mt-1">Streamlined processes and automation</p>
                </div>
              </li>
              <li className="flex items-start gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] hover:bg-white/[0.04] transition-colors">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center mt-0.5">
                ...
                <div>
                  <p className="text-white font-medium text-lg">Implementation guidance</p>
                  <p className="text-muted text-sm mt-1">Hands-on support throughout development</p>
                </div>
              </li>
            </ul>
          </div>
